...
# dbt authentication: the PAT serves both inference and SQL.
export SNOWFLAKE_AUTHENTICATOR=snowflake
export SNOWFLAKE_PASSWORD="${ANTHROPIC_AUTH_TOKEN:-}"
...
[ -z "${ANTHROPIC_BASE_URL:-}" ] && missing="$missing ANTHROPIC_BASE_URL"
